...
//build
  clBuildProgram(program,1,&device,"-cl-fast-relaxed-math -w",NULL,NULL);
...
//if build error
  ...
  //write to buffer A and B matrix
  ...
  //setting kernel kernel 인자 값 넘기기..
  ...
  // move to buffer to C metrix memory 
